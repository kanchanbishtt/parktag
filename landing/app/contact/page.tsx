    ...
    <PageLoader>
      ...
      <div className="min-h-screen bg-white pt-16">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-[#001935] mb-3 tracking-tight">
            Contact Us
          </h1>
          ...
          <div className="space-y-6">
            ...
            {/* Email */}
            <div className="flex items-start gap-4 p-5 rounded-2xl border border-gray-100 hover:border-[#1A9D20]/30 transition-colors">
              <div className="w-10 h-10 rounded-xl bg-[#1A9D20]/10 flex items-center justify-center flex-shrink-0">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#1A9D20" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                  <rect x="2" y="4" width="20" height="16" rx="2"/>
                  <path d="M2 7l10 7 10-7"/>
                </svg>
              </div>
              <div>
                <p className="text-sm font-semibold text-[#001935] mb-0.5">Email</p>
                <a href="mailto:support@parktag.me" className="text-[#1A9D20] hover:underline text-sm font-medium">
                  support@parktag.me
                </a>
            ...
            <div className="flex items-start gap-4 p-5 rounded-2xl border border-gray-100 hover:border-[#1A9D20]/30 transition-colors">
              ...
              <div>
                <p className="text-sm font-semibold text-[#001935] mb-0.5">Phone</p>
                <a href="tel:+918791638854" className="text-[#001935] font-medium text-sm hover:text-[#1A9D20] transition-colors">
                  +91 87916 38854
                </a>
            ...
            <div className="flex items-start gap-4 p-5 rounded-2xl border border-gray-100 hover:border-[#1A9D20]/30 transition-colors">
              ...
              <div>
                <p className="text-sm font-semibold text-[#001935] mb-0.5">Office</p>
            ...
            {/* Fleet enquiry */}
            <div className="mt-4 p-5 rounded-2xl bg-[#001935] text-white">
              ...
              <a
                ...
                className="inline-block text-xs font-bold bg-[#1A9D20] hover:bg-[#158018] text-white px-4 py-2 rounded-lg transition-colors"
              >
                Get Fleet Pricing
              </a>
            </div>
